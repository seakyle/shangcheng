...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="<s:url value='/admin/images/face.jpg' />" class="layui-circle" width="35" height="35">
							<cite><s:property value="name" /></cite>
						</a>
						<dl class="layui-nav-child">
							<dd><a href="javascript:;"   data-url="<s:url value='/Admin/edit' />?id=<s:property value='id' />"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
							<dd><a href="javascript:;" data-url="<s:url value='/admin/page/user/changePwd.jsp' />"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
							<dd><a href="<s:url value='/Admin/quit' />" ><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="<s:url value='/admin/images/face.jpg' />"></a>
				<p>你好！<span class="name"><s:property value="name" /></span>, 欢迎登录</p>
				<input type="hidden" class="type" value="<s:property value='type' />" />
				<input type="hidden" class="userName" value="<s:property value='userName' />" />
			</div>
	...
	<div class="admin-header-lock" id="lock-box" style="display: none;">
		<div class="admin-header-lock-img"><img src="<s:url value='/admin/images/face.jpg' />" /></div>
		<div class="admin-header-lock-name" id="lockUserName"><s:property value="name" /></div>
		<div class="input_btn">
	...
	<script type="text/javascript" src="<s:url value='/admin/js/leftNav.js' />"></script>
	<script type="text/javascript" src="<s:url value='/admin/js/index.js' />"></script>
</body>
</html>